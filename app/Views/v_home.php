                    ...
                    <div class="row">
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="services-icon">
                                <img src="<?= base_url() ?>/assets/logos/icon1.png" height="60" width="60" alt="Service">
                            </div>
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="services-icon">
                                <img class="icon-2" src="<?= base_url() ?>/assets/logos/icon2.png" height="60" width="60" alt="Service">
                            </div>
                            <div class="services-description">
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="services-icon">
                                <img class="icon-3" src="<?= base_url() ?>/assets/logos/icon3.png" height="60" width="60" alt="Service">
                            </div>
                            <div class="services-description">
                                <h1>FLAT UI-Interface</h1>
                                <p>
                                    Adminty ais first ever admin dashboard template which release in Bootstrap 4 framework. Intuitive feature rich design concept and color combination.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex-split">
            <div class="f-left wow fadeInUp" data-wow-delay="0s">
                <div class="left-content">
                    <img class="img-fluid" src="<?= base_url() ?>/assets/images/feature_1.png" alt="">
                </div>
            </div>
        ...
        <div class="flex-split">
            ...
            <div class="f-left">
                <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
                    <img class="img-fluid" src="<?= base_url() ?>/assets/images/feature_2.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="feature_huge text-center">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="<?= base_url() ?>/assets/images/big_feature.png" alt="" style="max-width:100%">
            </div>
            <div class="col-md-12 feature_list">
                <div class="row">
                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                        <img src="<?= base_url() ?>/assets/logos/feature_icon.png" alt="Feature">
                    ...
                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                        <img src="<?= base_url() ?>/assets/logos/feature_icon_2.png" alt="Feature">
                    ...
                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                        <img src="<?= base_url() ?>/assets/logos/feature_icon_3.png" alt="Feature">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
                            <div class="icon">
                                <img src="<?= base_url() ?>/assets/logos/cart2.png" alt="Icon">
                            </div>
                    ...
                    <div class="col-sm-6 ">
                        <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
                            <div class="icon">
                                <img src="<?= base_url() ?>/assets/logos/cart1.png" alt="Icon">
                            </div>
                            <div class="pricing-details">
                                <h2>Premium Plan</h2>
                                <span>$19.99</span>
...
<div class="client-section">
    <div class="container text-center">
        <div class="clients owl-carousel owl-theme">
            <div class="single">
                <img src="<?= base_url() ?>/assets/logos/logo1.png" alt="">
            </div>
            <div class="single">
                <img src="<?= base_url() ?>/assets/logos/logo2.png" alt="">
            </div>
            <div class="single">
                <img src="<?= base_url() ?>/assets/logos/logo3.png" alt="">
            </div>
            <div class="single">
                <img src="<?= base_url() ?>/assets/logos/logo4.png" alt="">
            </div>
            <div class="single">
                <img src="<?= base_url() ?>/assets/logos/logo6.png" alt="">
            </div>
            <div class="single">
                <img src="<?= base_url() ?>/assets/logos/logo7.png" alt="">
            </div>
        </div>
    </div>
</div>
...
<div class="cta-sub text-center no-color">
    <div class="container">
        ...
        <div class="form wow fadeInUp" data-wow-delay="0.3s">
            <form class="subscribe-form wow zoomIn" action="<?= base_url() ?>/assets/php/subscribe.php" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate="">
